# PR: chore/T2601271115-restart-preview

## 背景 / 目标
- 启动前后端开发预览服务，便于测试最新拖拽预览改动。
...
## 验证方式 / 结果
- (cd "E:\_wt\chore-T2601271115-restart-preview"; pnpm install)
- 前端：pnpm dev（监听 8000）
- 后端：pnpm start:dev（监听 6100）
- 端口检查：8000/6100 LISTENING

## 关键 Diff（自检）
5e29c7b (HEAD -> chore/T2601271115-restart-preview, spike/fullstack) merge: fix/T2601271108-drag-preview-image
