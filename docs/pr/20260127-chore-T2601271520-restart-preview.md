# PR: chore/T2601271520-restart-preview

## 背景 / 目标
- 重启前后端预览服务，便于验证内部拖拽高亮抑制（加强）。
...
## 验证方式 / 结果
- (cd "E:\_wt\chore-T2601271520-restart-preview"; pnpm install)
- 前端：pnpm dev（监听 8000）
- 后端：pnpm start:dev（监听 6100）
- 端口检查：8000/6100 LISTENING

## 关键 Diff（自检）
ff3961e (HEAD -> chore/T2601271520-restart-preview, spike/fullstack, fix/T2601271520-drag-ghost-preview) merge: fix/T2601271516-internal-drag-highlight-2
1796549 chore: add PR note and brief
601a170 fix: suppress highlight for internal drags reliably
9ef96a2 merge: chore/T2601271509-restart-preview
