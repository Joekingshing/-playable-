# PR: chore/T2601271404-restart-preview

## 背景 / 目标
- 重启前后端预览服务，便于验证拖拽预览优化。
...
## 验证方式 / 结果
- (cd "E:\_wt\chore-T2601271404-restart-preview"; pnpm install)
- 前端：pnpm dev（监听 8000）
- 后端：pnpm start:dev（监听 6100）
- 端口检查：8000/6100 LISTENING

## 关键 Diff（自检）
b31be50 (HEAD -> chore/T2601271404-restart-preview, spike/fullstack) merge: fix/T2601271401-drag-preview-sync
